...
import static ysy.game.model.Constant.*;


//main class for the game
public class GameMain extends JPanel {

    public static final GameMain MAIN = new GameMain();
    ...
    private final Map<byte[], Integer> playMap = new HashMap<>();
    int score = 0;
    //Define instance variables for the game objects
    private Food food;
    private Snake snake;
    private java.util.List<Snake> otherSnakes = new ArrayList<>();
    ...
    public void onAddPlayer(byte[] id) {
